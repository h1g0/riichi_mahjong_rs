...
| 半荘 | hanchan | hanchan / game | `GameSettings::round_count` (2) | The East and South rounds together. UI label: "4P Hanchan" / "3P Hanchan". |
| 東風戦 | tonpuusen | East-only game | `GameSettings::round_count` (1) | The East round only. UI label: "4P East" / "3P East". |
